...
urlpatterns = [
    ...
    path('open_add_item/<int:restaurant_id>', views.open_add_item, name='open_add_item'),
    path('open_edit_item/<int:item_id>/<int:restaurant_id>', views.open_edit_item, name='open_edit_item'),
    path('edit_item/<int:item_id>/<int:restaurant_id>', views.edit_item, name='edit_item'),
    path('delete_item_menu/<int:item_id>/<int:restaurant_id>', views.delete_item_menu, name='delete_item_menu'),
    ...
    path('delete_item_cart/<int:item_id>/<str:username>', views.delete_item_cart, name='delete_item_cart'),
